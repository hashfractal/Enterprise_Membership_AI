...
class CircularLinkedList:
	def __init__(self):
		self.__tail = Single_Linked_List.ListNode("Dummy", None)
	...
	def insert(self, i:int, newItem) -> None:
		if (i >= 0 and i <= self.__numItems):
			...
			newNode = Single_Linked_List.ListNode(newItem, prev.next)
			prev.next = newNode
	...
	def append(self, newItem) -> None:
		newNode = Single_Linked_List.ListNode(newItem, self.__tail.next)
	...
	def getNode(self, i:int) -> Single_Linked_List.ListNode:
